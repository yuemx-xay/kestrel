...
HAL_RCC_OscConfig(RCC_OscInitTypeDef *RCC_OscInitStruct) {
    ...
    if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI) ==
        ...
        if ((temp_sysclksrc == RCC_CFGR_SWS_HSI) ||
            ...
            /* Otherwise, only HSI division and calibration are allowed */
                ...
                /* Enable the Internal High Speed oscillator (HSI, HSIDIV2,
                 * HSIDIV4, or HSIDIV8) */
    ...
    if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_CSI) ==
        ...
        assert_param(IS_RCC_CSICALIBRATION_VALUE(
        ...
        if (__HAL_RCC_GET_SYSCLK_SOURCE() != RCC_CFGR_SWS_PLL1) {
            ...
            if (((RCC_OscInitStruct->PLL.PLLState) == RCC_PLL_OFF) ||
                ...
                ((READ_BIT(temp2_pllckcfg, RCC_PLL1DIVR_P1) >>
                  RCC_PLL1DIVR_P1_Pos) != (RCC_OscInitStruct->PLL.PLLP - 1U)) ||
                ((READ_BIT(temp2_pllckcfg, RCC_PLL1DIVR_Q1) >>
                  RCC_PLL1DIVR_Q1_Pos) != (RCC_OscInitStruct->PLL.PLLQ - 1U)) ||
                ((READ_BIT(temp2_pllckcfg, RCC_PLL1DIVR_R1) >>
                  RCC_PLL1DIVR_R1_Pos) != (RCC_OscInitStruct->PLL.PLLR - 1U))) {
                return HAL_ERROR;
            } else {
                ...
                if (RCC_OscInitStruct->PLL.PLLFRACN != temp1_pllckcfg) {
                    ...
                    /* Get Start Tick*/
                    tickstart = HAL_GetTick();
                    /* Wait at least 2 CK_REF (PLL input source divided by M)
                     * period to make sure next latched value will be taken into
                     * account. */
                    while ((HAL_GetTick() - tickstart) <
                           PLL_FRAC_TIMEOUT_VALUE) {
                    }
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef *RCC_OscInitStruct) {
    ...
    RCC_OscInitStruct->PLL.PLLN =
        (uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_N1) >> RCC_PLL1DIVR_N1_Pos) +
        1U;
    RCC_OscInitStruct->PLL.PLLR =
        (uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_R1) >> RCC_PLL1DIVR_R1_Pos) +
        1U;
    RCC_OscInitStruct->PLL.PLLP =
        (uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_P1) >> RCC_PLL1DIVR_P1_Pos) +
        1U;
    RCC_OscInitStruct->PLL.PLLQ =
        (uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_Q1) >> RCC_PLL1DIVR_Q1_Pos) +
        1U;
