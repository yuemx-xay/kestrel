...
typedef struct {
    ...
    uint32_t HSICalibrationValue; /*!< The calibration trimming value.
                                     ...
                                     Min_Data = 0x00 and Max_Data = 0x3F for
                                     STM32H7 rev.Y This parameter must be a
                                     number between Min_Data = 0x00 and Max_Data
                                     = 0x7F for STM32H7 rev.B and above */
    ...
    uint32_t CSICalibrationValue; /*!< The calibration trimming value.
                                       This parameter must be a number between
                                     Min_Data = 0x00 and Max_Data = 0x1F for
                                     STM32H7 rev.Y This parameter must be a
                                     number between Min_Data = 0x00 and Max_Data
                                     = 0x3F for STM32H7 rev.B and above */
...
typedef struct {
    ...
    uint32_t SYSCLKDivider; /*!< The system clock  divider. This parameter can
                               be a value of @ref RCC_SYS_Clock_Source */

    uint32_t
        AHBCLKDivider; /*!< The AHB clock (HCLK) divider. This clock is derived
                          from the system clock (SYSCLK). This parameter can be
                          a value of @ref RCC_HCLK_Clock_Source */

    uint32_t
        APB3CLKDivider; /*!< The APB3 clock (D1PCLK1) divider. This clock is
                           derived from the AHB clock (HCLK). This parameter can
                           be a value of @ref RCC_APB3_Clock_Source */
    ...
    uint32_t
        APB2CLKDivider; /*!< The APB2 clock (PCLK2) divider. This clock is
                           derived from the AHB clock (HCLK). This parameter can
                           be a value of @ref RCC_APB2_Clock_Source */
    uint32_t
        APB4CLKDivider; /*!< The APB4 clock (D3PCLK1) divider. This clock is
                           derived from the AHB clock (HCLK). This parameter can
                           be a value of @ref RCC_APB4_Clock_Source */
} RCC_ClkInitTypeDef;
...
#define __HAL_RCC_AHB1_FORCE_RESET()                                           \
    (RCC->AHB1RSTR =                                                           \
         0x02000223U) /* Resets DMA1, DMA2, ADC12, CRC and USB1OTG */
#else
#define __HAL_RCC_AHB1_FORCE_RESET()                                           \
    (RCC->AHB1RSTR =                                                           \
...
#else
#define __HAL_RCC_AHB2_FORCE_RESET()                                           \
    (RCC->AHB2RSTR = 0x00030271U) /* Resets DCMI_PSSI, CRYPT, HASH, RNG,       \
                                     SDMMC2, FMAC and CORDIC */
#endif                            /* STM32H7_DEV_ID == 0x450UL */
#if defined(DCMI) && defined(PSSI)
...
#define __HAL_RCC_DCMI_CLK_SLEEP_DISABLE()                                     \
    __HAL_RCC_DCMI_PSSI_CLK_SLEEP_DISABLE() /* for API backward                \
                                               compatibility*/
#else
#define __HAL_RCC_DCMI_CLK_SLEEP_DISABLE()                                     \
    (RCC->AHB2LPENR &= ~(RCC_AHB2LPENR_DCMILPEN))
...
#define __HAL_RCC_D3SRAM1_IS_CLK_SLEEP_DISABLED                                \
    __HAL_RCC_SRDSRAM_IS_CLK_SLEEP_DISABLED /* For API backward                \
                                               compatibility*/
#else
#define __HAL_RCC_D3SRAM1_IS_CLK_SLEEP_DISABLED()                              \
    ((RCC->AHB4LPENR & (RCC_AHB4LPENR_D3SRAM1LPEN)) == 0U)
...
#define IS_RCC_MCO2SOURCE(SOURCE)                                              \
    (((SOURCE) == RCC_MCO2SOURCE_SYSCLK) ||                                    \
     ...
     ((SOURCE) == RCC_MCO2SOURCE_CSICLK) ||                                    \
     ((SOURCE) == RCC_MCO2SOURCE_LSICLK))
